...
@click.command(name="activate_extension", help="[New]Activate a parser extension")
...
@click.argument("extension_id", required=True, default="")
@options.env_option
...
def activate_extension(
  ...
  """Activate a parser extension given the Parser ID.
  ...
  Args:
    ...
    extension_id (int): The Parser ID.
  ...
  if not extension_id:
    click.echo("Extension ID not provided. Please enter Extension ID")
    return

  click.echo("Activating Extension...")
  ...
  click.echo("Extension activated successfully.")
